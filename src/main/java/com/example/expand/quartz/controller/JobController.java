package com.example.expand.quartz.controller;

import cn.hutool.core.lang.Dict;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.example.expand.quartz.JobService;
import com.example.expand.quartz.common.ApiResponse;
import com.example.expand.quartz.entity.domain.JobAndTrigger;
import com.example.expand.quartz.entity.form.JobForm;
...
public class JobController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse> addJob(@Valid @RequestBody JobForm form) {
        try {
     ...
     */
    @DeleteMapping
    public ResponseEntity<ApiResponse> deleteJob(@RequestBody JobForm form) throws SchedulerException {
